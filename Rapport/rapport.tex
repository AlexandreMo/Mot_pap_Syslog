...
\begin{document}	
	...
	\newpage
	\input{chapitres/AnalyseEtConceptionD}
	\newpage
	\input{chapitres/AnalyseEtConceptionaDEN.tex}
	\newpage
	\input{chapitres/AnalyseEtConceptionT.tex}
	\newpage
	\input{chapitres/AnalyseEtConceptionRS.tex}
	\newpage
	\input{chapitres/AnalyseEtConceptionLatch.tex}
	\newpage
	\input{chapitres/AnalyseEtConceptionJK.tex}
	\newpage
	\input{chapitres/Conclusion.tex}
	%Section pour la signature
	\section{Signature}
  
    Yverdon-les-Bains le 18.04.2026 \\
    \begin{center}
      \nomAuteur
    \end{center}
